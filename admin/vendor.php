...
<div class="content-wrapper" style="min-height: 170vh;">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <a href="vendor_form.php"><button class="btn btn-outline-primary">Add Vendor</button></a>
          </div>
        </div>
      </div>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive-xxl">
                  <table class="table" id="vendor_table">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>First Name</th>
